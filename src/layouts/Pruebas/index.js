...
/*
Metodo de creacion de servicio de nssm
mkdir c:\temp
nssm install Node-RED "c:\Users\\"%Administrador%"\AppData\Roaming\npm\node-red.cmd"
nssm set Node-RED AppDirectory "c:\Users\\"%Administrador%"\.node-red"
nssm set Node-RED AppParameters "-u c:\users\\"%Administrador%"\.node-red > c:\temp\node-red.log"
...
export const Pruebas = () => {
  ...
  //? Estructura para las graficas grafica (No es necesario para todas las graficas, solo en estas)
  //? -->
  const labelOption = {
    show: true,
          ...
          <Grid item xs={12} md={12} lg={12}>
            ...
            <MDBox mb={1.5}>
              <Card sx={{ height: "100%" }}>
                ...
                {/* Trabajando */}
                <Typography variant='h6' align='center' > Reporte consumo agua </Typography>
                <Bar data={state}
                  options={
                    {
                      plugins: {
                ...
                <ReactECharts option={stateop} style={{ height: '400px' }} />
              </Card>
            </MDBox>
          </Grid>
        </Grid>
